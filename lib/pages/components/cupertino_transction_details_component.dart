            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  TransactionItem(title: 'Hash', content: transaction.hash),
                  TransactionItem(
                      title: 'Transaction Block',
                      content: transaction.blockNumber),
                  TransactionItem(
                      title: 'Time', content: transaction.timeStamp),
                  TransactionItem(
                      title: 'Gas', content: '${transaction.gas} (MATIC)'),
                  TransactionItem(title: 'Nonce', content: transaction.nonce),
                  TransactionItem(
                      title: 'Amount sent',
                      content: '${transaction.value} (MATIC)'),
                  TransactionItem(
                      title: 'Function', content: transaction.functionName)
                ],
              ),
            ),
          ],
